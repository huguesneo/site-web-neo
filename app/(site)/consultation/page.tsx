...
export const metadata: Metadata = {
  ...
  description: 'Réservez votre consultation gratuite de 45 minutes avec un naturopathe NEO Performance. Virtuelle ou en clinique à Brossard. Bilan métabolique personnalisé.',
  alternates: {
